...
export const faqData = [
  {
    question: "What is Stiryum?",
    answer:
      "Stiryum is an AI-powered recruitment platform that helps companies match candidates to roles more accurately by using semantic AI embeddings instead of traditional keyword-based screening.",
  },
  {
    question: "How does Stiryum match candidates with jobs?",
    answer:
      "Stiryum converts CVs and job descriptions into AI embeddings that capture skills, experience, and context. These embeddings are compared to identify true alignment between candidates and roles, resulting in more accurate matches than keyword filtering.",
  },
  {
    question: "Can I upload CVs in bulk?",
    answer:
      "Yes. Stiryum allows bulk CV uploads, automatically parsing each CV and generating structured, AI-enhanced candidate profiles.",
  },
  {
    question: "Can Stiryum generate job descriptions?",
    answer:
      "Yes. Stiryum includes an AI chatbot that can generate job descriptions based on role requirements, seniority, skills, and industry, or enhance existing JDs for better candidate matching.",
  },
  {
    question: "Who is Stiryum best suited for?",
    answer:
      "Stiryum is ideal for recruiters, HR teams, and staffing agencies looking to move beyond manual screening and leverage AI for high-precision hiring.",
  },
];
