  ...
  return (
    <button
      ...
      px-2 py-2 md:px-4 text-md md:text-lg md:py-2 rounded-4xl  transition-all duration-300 
        ...
        data-[variant=tertiary]:bg-[linear-gradient(to_bottom,#f1bf50_0%,#976B03_100%)] data-[variant=tertiary]:text-blue-950 data-[variant=tertiary]:rounded-md data-[variant=tertiary]:hover:shadow-[0_10px_20px_-5px_rgba(241,191,80,0.5)] data-[variant=tertiary]:hover:scale-[1.02] data-[variant=tertiary]:hover:-translate-y-1
        hover:opacity-90"}`}
    >
      {children}
    </button>
