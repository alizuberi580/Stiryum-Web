                    ...
                    >
                        ...
                        <div className="p-6 sm:p-8 flex flex-col h-full">
                            ...
                            <div className="mb-3 flex items-center justify-between">
                                <h3 className={`text-2xl font-bold ${plan.highlighted
                            ...
                            {/* Price */}
                            <div className={`text-center mb-3 pb-3 md:mb-4 md:pb-4 lg:mb-5 lg:pb-5 border-b ${plan.highlighted ? 'border-[#f1bf50]/40' : 'border-white/10'}`}>
                            ...
                            <div className="flex-grow mb-8">
                                <p className={`text-xs font-semibold uppercase tracking-wider mb-4 ${plan.highlighted ? 'text-[#f1bf50]' : 'text-gray-400'}`}>
                                    What's Included
                                </p>
                                <ul className="space-y-3">
                                    {plan.features.map((feature, featureIndex) => (
                                        <li key={featureIndex} className="flex items-start gap-3">
                                            {feature.included ? (
                                                <Check className={`w-4 h-4 flex-shrink-0 mt-0.5 ${plan.highlighted ? 'text-[#f1bf50]' : 'text-[#f1bf50]/50'}`} />
                                            ) : (
                            ...
                            <button
                                ...
                                className={`w-full py-2 rounded-md font-semibold transition-all duration-300 text-base ${plan.highlighted
                                    ? "bg-gradient-to-b from-[#f1bf50] to-[#976B03] text-white "
                                    : "text-[#ffffff]/50 hover:bg-white/5 hover:text-gray-400 border border-[#976B03]/20 bg-gradient-to-b from-[#f1bf50]/10 to-[#976B03]/10"
                                    }`}
                                style={{
                                }}
                            >
